...
res1 = Restaurant.create(:name => "Mary's", :address => "154 Castlereagh Street, CBD, Sydney", :hours => "10 AM to 10 PM", :yelp_rating => "3.2", :avg_burger_rating => "4", :yelp_link => "http://www.yelp.com.au/biz/marys-city-sydney-3", :latitude => "-33.872311", :longitude => "151.209503" )
